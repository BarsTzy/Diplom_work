...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    ...
    // получение списка снимков в нашем потоке
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (groupName != "") {
                      ...
                      Navigator.of(context).pop();
                      showSnackbar(
                          context, Colors.green, "Группа успешно создана.");
                    }
                  },
                  style: ElevatedButton.styleFrom(
                      primary: Theme.of(context).primaryColor),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "Вы не присоединились ни к одной группе, нажмите значок добавления, чтобы создать группу, или выполните поиск с помощью верхней кнопки поиска.",
            textAlign: TextAlign.center,
          )
        ],
      ),
