...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget groupTile(
    ...
    // Функция, чтобы проверить, существует ли пользователь уже в группе
      ...
      trailing: InkWell(
        onTap: () async {
          ...
          if (isJoined) {
            ...
            showSnackbar(
                context, Colors.green, "Успешно присоединился к группе");
            ...
            setState(() {
              isJoined = !isJoined;
              showSnackbar(context, Colors.red, "Покинул группу $groupName");
            });
          }
        },
        child: isJoined
            ...
            : Container(
                ...
                padding:
                    const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                child: const Text("Присоединиться сейчас",
                    style: TextStyle(color: Colors.white)),
              ),
      ),
    );
